...
import { TransformationDrill as TransformationDrillType } from '@/types/drill';
...
interface TransformationDrillProps {
  drill: TransformationDrillType;
  index: number;
}

export function TransformationDrill({ drill, index }: TransformationDrillProps) {
      ...
      <CardContent className="p-6 space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Badge variant="outline" className="text-sm py-1 px-3">
            <span className="font-english mr-2">{drill.targetForm}</span>
            <span className="font-korean text-muted-foreground">/ {drill.targetFormKorean}</span>
          </Badge>
        </div>
        ...
        <div className="space-y-3">
          <div className="flex gap-2">
            <Input
              ...
              placeholder="Transform the sentence... / 문장을 변형하세요..."
